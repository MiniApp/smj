...
public final class JSONUtil
{
	...
	/**    
	 * 方法：     ListToJsonString
	 * 功能：     List转换String JSONObject对象 
	 * @param  List rows, int pages, int total
	 * @return String JSONObject对象    
	 * @since   
	 */
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public static String ListToJsonString(List rows, int pages, int total) {
		JSONUtil.collection2json(rows);

...
public class Base64{
	...
	public static void main(String[]args){
		...
		String oldpwd  = "/C/TruFwSfP524NcVqF8Hg==";
		String pwd = encryptStringBase64("chenwenlei","mMu6CHXEy3MldhN2nl2AmObIkfgWOzJM");
		System.out.println((oldpwd.equals(pwd.trim())) + " " + pwd);

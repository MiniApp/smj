...
public class Comm_info implements java.io.Serializable {
	...
	/** minimal constructor */
	public Comm_info(CommInfoId id) {
		this.id = id;
	}

	/** full constructor */
	public Comm_info(CommInfoId id, String commdName, String commdLogo,
			String img1, String img2, String img3, String oneDimension,
			String twoDimension, Integer UId, 
			Integer cateId,Integer brandId,
			String commdWeight,String commdLicense, 
			String commdCreaDate,String commdProducePlace, String commdSize,
			String commdDescription,String supplier, 
			Double agoraPrice, Double userPrice,
			Float salePrice, Float promPrice, String taste, String equip,

...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	...
	<meta name="Keywords" content="网上超市，网络购物，日常家居生活用品" /><script type="text/javascript" src="${ctx}/js/jquery-1.4.4.min.js"></script>
...
<div>
    <table id="bill_table" width="100%" border="1" bordercolor="#cccccc" cellspacing="0" cellpadding="0" class="caicardetail">
      ...
      <tr>
        <td colspan="7">${smj:htmlPages(p_no,p_num)}</td>
      </tr>
      </c:when>

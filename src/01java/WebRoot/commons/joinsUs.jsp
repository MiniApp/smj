...
.joinbox-top { background: url(../images/pic04.gif) 0px 0px; margin: 0 auto; width: 220px; height: 3px; line-height: 0px; font-size: 0px; }
.joinbox-bottom { background: url(../images/pic04.gif) 0px -4px; margin: 0 auto; width: 220px; height: 4px; line-height: 0px; font-size: 0px; }
.jiantou01 { background: url(../images/jt01-1.gif) no-repeat 14px center; float: left; }
.box-top { background: url($(../images/pic07.gif) 0px 0px; margin: 0 auto; width: 728px; height: 7px; line-height: 0px; font-size: 0px; }
.box-bottom { background: url(../images/pic07.gif) 0px -8px; margin: 0 auto; width: 728px; height: 7px; line-height: 0px; font-size: 0px; }
...
#joins .right .content .zhiwei { background-image: url(../images/pic10.gif); width: 675px; margin: 10px auto 0; height: 19px; padding: 15px 0 0 17px; font-size: 12px; color: #FFF; font-weight: bold; }
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="mainbox"><tr><td>
	<div id="banner"><img src="../images/pic05.jpg" width="960" height="140" /></div>
    <div id="joins">
        <div class="left"><div class="joinbox-top"></div><div class="content">
        	<div style="margin-bottom: 2px;"><img src="../images/pic05.gif" /></div>
...
简历请投HR信箱：<font style="font-size: 20px; font-weight: bold;"></font>，邮件标题请注明投递的职位名称。<br />如通过初审，将会电话预约面谈时间，谢谢配合！</div>

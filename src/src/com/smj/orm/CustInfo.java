...
public class CustInfo  implements java.io.Serializable {
    ...
    /** full constructor */
    public CustInfo(String name, String nickName, String isCert, String mobile, String email, String qq, String pwd, Integer accu, Integer isValidate, Integer userRank, Timestamp regDate, String radomStr1, String radomStr2, String userState) {
        this.name = name;

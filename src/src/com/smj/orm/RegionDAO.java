...
public class RegionDAO extends BaseHibernateDAO  {
    ...
    public Region findById( java.lang.Integer id) {
        ...
        try {
            Region instance = (Region) getSession()
                    .get("com.smj.orm.Region", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Region instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.smj.orm.Region")
	...
	public List findByChildNum(Object childNum
	) {
		return findByProperty(CHILD_NUM, childNum
		);
	}
    ...
    public Region merge(Region detachedInstance) {
        ...
        try {
            Region result = (Region) getSession()

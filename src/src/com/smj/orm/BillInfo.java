...
public class BillInfo implements java.io.Serializable {
	...
	/** full constructor */
	public BillInfo(Date billDate, Integer custId, Integer billType,
			String custName, String custTel, String custAddr, Integer accu,
			String isInvoice, String isVintegral, Double amt, String billState,
			Integer payType, String rejectFlg, String rejectCause,
			Date rejectTime, Double deliverFee, String billAppr,
			String userAppr, Date apprTime, Date deliverTime, String memo) {

...
public class CommInfo  implements java.io.Serializable {
    ...
    /** full constructor */
    public CommInfo(CommInfoId id, String commdName, String commdLogo, String img1, String img2, String img3, String oneDimension, String twoDimension, Integer UId, String commdWeight, String commdLicense, String commdCreaDate, String commdProducePlace, String commdSize, String commdDescription, Double agoraPrice, Double userPrice, Double salePrice, Double promPrice, String taste, String equip, Integer integral, Integer mixNum, Integer haveNum, String qualified, Integer uses, Integer number, Integer memo, String remark1, String remark2, String remark3, String remark4, String remark5) {
        this.id = id;

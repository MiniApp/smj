...
public class StoreInfo implements java.io.Serializable {
	...
	/** full constructor */
	public StoreInfo(Integer enterId, String storeName, Integer storeLevel,
			String storeAddr, String contPerson, String contTel, String contQq,
			String storeLogo, String service, Time busiStartHour,
			Time busiEndHour, Double deliverPrice, Double shippingFee,
			Integer respTime, Integer storeState, Timestamp regDate,
			Integer storeType, Integer storeRankAccu, String storeRank,
			String storeCredit, Integer orderNum, Integer accessNum,
			String deliverRange) {

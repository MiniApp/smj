...
<div id="sys_mes">
	...
	<div class="con">
		<ul>
			<li>
				<a href="${ctx}/publicAction.do?method=sysmesList" target="_blank">您有新的消息</a>（
		...
		<div class="lft">
			<p class="logo">
				<a href="http://www.sunbyway.com"><img
						src="${ctx}/images/logo.gif" alt="尚佰味" border="0" width="210"
						height="55" /> </a>
			</p>
			<p class="txt">
				打造天津本地最好的
			...
			<div class="topbar">
				<c:choose>
					<c:when test="${sGlobal.smj_userid>0}">
   					...
   					&nbsp;<a href="${ctx}/userAction.do?method=user">个人中心</a>&nbsp;|
   					&nbsp;<a href="${ctx}/userAction.do?method=favorite">收藏夹</a>&nbsp;|
   					&nbsp;<a href="${ctx}/publicAction.do?method=sysmesList"
							target="_blank">消息</a>&nbsp;|
   				</c:when>
					<c:otherwise>
   					亲，欢迎来宋美佳！
				...
				&nbsp;
				<a href="${ctx}/mregister.jsp" class="col_f60">餐饮店加盟</a>&nbsp;|&nbsp;
				<c:choose>
					<c:when test="${sGlobal.smj_userid>0}">
						<a href="${ctx}/userAction.do?method=logout">退出</a>
					</c:when>
					<c:otherwise>
				...
				&nbsp;-&nbsp;
				<a href="#"
					onclick="AddFavorite('http://www.sunbyway.com','尚佰味网 - 要美味，就尚佰味！');"
					class="col_f60">[加入收藏]</a>
			</div>
			<div class="menubar">
				<ul>
					<li <logic:equal value="5" name="tag">class="sel"</logic:equal>>
						<a href="${ctx}/slogin.jsp"><span>系统设置</span> </a>
					</li>
					<li <logic:equal value="1" name="tag">class="sel"</logic:equal>>
						<a href="${ctx}/mlogin.jsp"><span>店铺管理</span> </a>
					</li>
					<li <logic:equal value="3" name="tag">class="sel"</logic:equal>>
						<a href="${ctx}/userAction.do?method=leavewordList"><span>留言板</span>
						</a>
					</li>
					<li <logic:equal value="4" name="tag">class="sel"</logic:equal>>
						<a href="${ctx}/userAction.do?method=storesList"><span>商品列表</span>
						</a>
					</li>
